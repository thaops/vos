...
import 'package:vos_flutter/feature/webview/view/webview_tab.dart';
        ...
        child: Theme(
          ...
          child: NavigationBar(
            ...
            destinations: [
              ...
              NavigationDestination(
                icon: Icon(Icons.web_outlined, color: Colors.grey.shade600),
                selectedIcon: Icon(Icons.web_rounded, color: Colors.white),
                label: 'WebView',
              ),
              NavigationDestination(
